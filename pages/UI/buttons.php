            ...
            <div class="box box-primary">
                ...
                <div class="box-body table-responsive">
                    ...
                    <table class="table table-bordered text-center">
                        ...
                        <tr>
                            <td>
                                <button type="button" class="btn btn-block btn-default">Default or Secondary</button>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-block btn-teal btn-lg">Teal</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-teal btn-sm">Teal</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-teal btn-xs">Teal</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-teal btn-flat">Teal</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-teal disabled">Teal</button>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <button type="button" class="btn btn-block btn-navy">Navy</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-navy btn-lg">Navy</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-navy btn-sm">Navy</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-navy btn-xs">Navy</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-navy btn-flat">Navy</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-navy disabled">Navy</button>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <button type="button" class="btn btn-block btn-purple btn-lg">Purple</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-purple btn-sm">Purple</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-purple btn-xs">Purple</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-purple btn-flat">Purple</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-purple disabled">Purple</button>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <button type="button" class="btn btn-block btn-orange">Orange</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-orange btn-lg">Orange</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-orange btn-sm">Orange</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-orange btn-xs">Orange</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-orange btn-flat">Orange</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-orange disabled">Orange</button>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <button type="button" class="btn btn-block btn-maroon">Maroon</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-maroon btn-lg">Maroon</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-maroon btn-sm">Maroon</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-maroon btn-xs">Maroon</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-maroon btn-flat">Maroon</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-maroon disabled">Maroon</button>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <button type="button" class="btn btn-block btn-black">Black</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-black btn-lg">Black</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-black btn-sm">Black</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-black btn-xs">Black</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-black btn-flat">Black</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-block btn-black disabled">Black</button>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                ...
                <div class="box-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-default btn-flat dropdown-toggle" data-bs-toggle="dropdown">
                                    <span class="fa fa-caret-down"></span>
                                </button>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#">Dropdown link</a></li>
                        ...
                        <div class="btn-group">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-danger btn-flat dropdown-toggle" data-bs-toggle="dropdown">
                                    <span class="fa fa-caret-down"></span>
                                </button>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#">Dropdown link</a></li>
                        ...
                        <div class="btn-group">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-success btn-flat dropdown-toggle" data-bs-toggle="dropdown">
                                    <span class="fa fa-caret-down"></span>
                                </button>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#">Dropdown link</a></li>
                        ...
                        <div class="btn-group">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-warning btn-flat dropdown-toggle" data-bs-toggle="dropdown">
                                    <span class="fa fa-caret-down"></span>
                                </button>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#">Dropdown link</a></li>
